    ...
    connection.query('DELETE FROM product_categories', (err) => {
        ...
        `, (err) => {
            ...
            connection.query(`
                ...
                ADD COLUMN IF NOT EXISTS calculated_daily_rent DECIMAL(10,2),
                ADD COLUMN IF NOT EXISTS calculated_monthly_rent DECIMAL(10,2)
            `, (err) => {
                if (err) {
...
function createDepreciationSettingsTable() {
    ...
    `, (err) => {
        ...
        connection.query(`
            ...
            ('其他配件', 0.0100, 48, '其他配件按2.5%月折旧率，48个月使用期'),
